    ...
    if media_url:
        ...
        try:
            ...
            if video_path:
                ...
                kb = InlineKeyboardMarkup(inline_keyboard=[
                    [InlineKeyboardButton(text="🎵 Qo'shiqni yuklash", callback_data="getsong")],
                    [InlineKeyboardButton(text="🎧 Audioni yuklash", callback_data="getaudio")],
                ])
                try:
                ...
                await status.edit_text("❌ Video yuklab bo'lmadi (150MB dan katta yoki yopiq).")
        except Exception as e:
