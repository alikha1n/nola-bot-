...
def ck():
    """yt-dlp uchun qo'shimcha argumentlar:
    - cookie fayli bor bo'lsa --cookies
    - YouTube bot-tekshiruvini chetlab o'tish uchun bir nechta client (android/ios/web)
      va qo'shimcha himoyalardan o'tish sozlamalari.
    """
    args = []
    if COOKIES:
        args += ["--cookies", COOKIES]
    # Android/iOS klientlari ko'pincha "Sign in to confirm you're not a bot"
    # tekshiruvini chetlab o'tadi va imzo (signature) muammosi bo'lmaydi.
    args += [
